...
\abstract{
    This paper is about creating a programming language and an accompanying
    interperter. The goal is to learn about algorithms and techniques already
    popular in the industry, while still creating something unique.



    The source code of the interpreter can be found on GitHub at
    \url{https://github.com/LeFlorians/TestScript}.


    The source code as of the latest commit before hand-in date of the paper
    is available at
...
\ver{\begin{flushleft}
    ...
    \dirtree{%
        ...
        .2 \hrc{mapop.gperf}.
        .2 pseudocode.
            .3 \hrc{pseudocode/pratt_parser.c}.
        .2 examples.
...
The file named \hrc{Makefile} carries information for the program \emph{GNU make}.
It contains built targets, which are specifications on how to build and compile
the C source code down to the final executable interpreter. 
...
by this project.
% TODO: validate code
\code{pseudocode/pratt_parser.c}{1}{999}
