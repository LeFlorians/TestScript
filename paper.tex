...
\begin{titlepage}\begin{center}
    ...
    \Large
    \vfill
    Matura Paper written by\\ \ver{\textbf{Florian M. Donnelly}}
    
    \vspace{0.5cm}
    Under Supervision of\\ \ver{\textbf{Adrian Lüthi}}

    \vspace{0.5cm}
    Gymnasium Burgdorf\ver{, 23e}\\ October 31, 2022
...
\begin{abstract}
    ...
    \ver{\url{https://github.com/LeFlorians/TestScript}.}

    The source code as of the latest commit before the submission of the paper
    is available at:

    \ver{\url{https://github.com/LeFlorians/TestScript/tree/\githash}.}
...
By typing my full name below, I confirm that the matura paper I am submitting is entirely
my own original work except where otherwise indicated. I am aware of the shool regulations
concerning plagiarism.

\ver{Florian Michael Donnelly}
